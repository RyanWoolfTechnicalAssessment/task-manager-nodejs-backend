...
//         it("should return an added user role", async () => {
...
//             const userRepository: IUserRepository = new UserRepositoryMockImpl();
//             const existingUserroleRequest: IAddUserRoleRequest = {
//                 userName: "test@existinguser.co.za",
//                 authority: "CLIENT_ROLE",
//             };
//
//             const existingUserRole: IAddUserRole =
//                 new AddUserRoleImpl(existingUserroleRequest, userRepository);
//             await existingUserRole.init();
//
//             // @ts-ignore
//             expect(existingUserRole.user.id).toBe(
//                 1,
//             );
//
//         });
